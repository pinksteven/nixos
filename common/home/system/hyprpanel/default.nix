      ...
      ''
        {
          ...
          "menus.dashboard.shortcuts.right.shortcut2.icon": "󰅶",
          "menus.dashboard.shortcuts.right.shortcut2.command": "caffeine",
          "menus.dashboard.shortcuts.right.shortcut2.tooltip": "Caffeine",
