{ config, pkgs, ... }:
let
  icons-path = "/home/" + config.var.username + "/.cache/wlogout";
  ...
  focus-border = border-size * 2;
  margin-size = 10;
  focus-margin = margin-size - border-size;
      ...
      ''
        * {
        ...
        button {
            ...
            border: ${toString border-size}px solid ${base0D};
            ...
            background-size: 20%;
            margin: ${toString margin-size}px;
        }
        ...
        button:focus {
            margin: ${toString focus-margin}px;
            border: ${toString focus-border}px solid ${base0E};
            outline-style: none;
        }

        #lock {
            background-image: url("${icons-path}/lock.svg");
        }

        #logout {
            background-image: url("${icons-path}/logout.svg");
        }

        #suspend {
            background-image: url("${icons-path}/suspend.svg");
        }

        #hibernate {
            background-image: url("${icons-path}/hibernate.svg");
        }

        #shutdown {
            background-image: url("${icons-path}/shutdown.svg");
        }

        #reboot {
            background-image: url("${icons-path}/reboot.svg");
        }
      '';
  };
  home.file.".cache/wlogout/lock.svg".text = # svg
    ''
      <?xml version="1.0" encoding="utf-8"?>
      <!-- Svg Vector Icons : http://www.onlinewebfonts.com/icon -->
      <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" xml:space="preserve" fill="${base0D}">
    ...
    '';
  home.file.".cache/wlogout/logout.svg".text = # svg
    ''
      <?xml version="1.0" encoding="utf-8"?>
      <!-- Svg Vector Icons : http://www.onlinewebfonts.com/icon -->
      <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
    ...
    '';
  home.file.".cache/wlogout/suspend.svg".text = # svg
    ''
      <?xml version="1.0" encoding="utf-8"?>
      <!-- Svg Vector Icons : http://www.onlinewebfonts.com/icon -->
      <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
    ...
    '';
  home.file.".cache/wlogout/hibernate.svg".text = # svg
    ''
      <?xml version="1.0" encoding="utf-8"?>
      <!-- Svg Vector Icons : http://www.onlinewebfonts.com/icon -->
      <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
    ...
    '';
  home.file.".cache/wlogout/shutdown.svg".text = # svg
    ''
      <?xml version="1.0" encoding="utf-8"?>
      <!-- Svg Vector Icons : http://www.onlinewebfonts.com/icon -->
      <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
    ...
    '';
  home.file.".cache/wlogout/reboot.svg".text = # svg
    ''
      <?xml version="1.0" encoding="utf-8"?>
      <!-- Svg Vector Icons : http://www.onlinewebfonts.com/icon -->
      <!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">
