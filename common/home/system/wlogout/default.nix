...
in {
    ...
    home.file.".cache/wlogout/lock.svg" = {
        text = #svg
        ''
    ...
    home.file.".cache/wlogout/logout.svg" = {
        text = #svg
        ''
        <?xml version="1.0" encoding="utf-8"?>
        <!-- Svg Vector Icons : http://www.onlinewebfonts.com/icon -->
    ...
    home.file.".cache/wlogout/suspend.svg" = {
        text = #svg
        ''
        <?xml version="1.0" encoding="utf-8"?>
        <!-- Svg Vector Icons : http://www.onlinewebfonts.com/icon -->
    ...
    home.file.".cache/wlogout/hibernate.svg" = {
        text = #svg
        ''
        <?xml version="1.0" encoding="utf-8"?>
        <!-- Svg Vector Icons : http://www.onlinewebfonts.com/icon -->
    ...
    home.file.".cache/wlogout/shutdown.svg" = {
        text = #svg
        ''
        <?xml version="1.0" encoding="utf-8"?>
        <!-- Svg Vector Icons : http://www.onlinewebfonts.com/icon -->
    ...
    home.file.".cache/wlogout/reboot.svg" = {
        text = #svg
        ''
        <?xml version="1.0" encoding="utf-8"?>
        <!-- Svg Vector Icons : http://www.onlinewebfonts.com/icon -->
